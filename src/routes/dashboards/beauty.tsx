...
function BeautyDashboardPage() {
  ...
  const handleExportConsultations = (format: "pdf" | "word" | "excel") => {
    try {
      ...
      if (format === "excel") {
        const headers = ["Client Name", "Age", "Gender", "Phone", "Email", "Date & Time", "Client Requests", "Status"];
                        ...
                        >
                          <div className="space-y-2">
                            ...
                            <div className="grid grid-cols-2 gap-2 text-[10px] text-zinc-500 font-semibold leading-relaxed">
                              ...
                              <div>
                                <span className="text-zinc-400 block text-[8px] uppercase font-bold tracking-wider">Assigned Stylist</span>
                            ...
                            {apt.reason && (
                              <div className="bg-zinc-50/50 p-2 rounded-lg border border-zinc-150/40">
                                <span className="text-zinc-400 block text-[8px] uppercase font-bold tracking-wider">Client Requests</span>
                    ...
                    <div className="lg:col-span-1 space-y-4">
                      <div className="rounded-2xl border border-zinc-200/80 bg-white p-5 space-y-4 shadow-sm">
                        ...
                        <div className="space-y-3.5 text-xs text-left">
                          ...
                          <div>
                            <span className="text-zinc-400 block text-[9px] font-bold uppercase tracking-tight">First Visit Date</span>
                  ...
                  <div className="rounded-2xl border border-zinc-200 bg-white p-5 space-y-4">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-[10px] text-zinc-400 mt-0.5">Client treatment volume over time</p>
                      </div>
                    ...
                    >
                      <form onSubmit={handleAddPatientSubmit} className="rounded-2xl border border-zinc-200 bg-white p-5 grid gap-4 sm:grid-cols-4 items-end">
                        ...
                        <div className="space-y-1 sm:col-span-2">
                          <label className="text-[10px] font-bold text-zinc-400 uppercase">Primary Goal / Style Preference</label>
                          <input
                            type="text"
                        ...
                        <div className="space-y-1 sm:col-span-2">
                          <label className="text-[10px] font-bold text-zinc-400 uppercase">Allergies / Special Concerns</label>
                          <input
                            type="text"
              ...
              >
                ...
                <div className="border-b border-zinc-100 pb-4">
                  ...
                  <p className="text-[10px] text-zinc-400 mt-1.5 leading-relaxed">
                    Configure salon/spa profiles, working hours, service categories, staff schedules, and WhatsApp alerts.
                  </p>
                </div>
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-4 p-4 rounded-2xl bg-zinc-50 border border-zinc-150">
                          ...
                          <div className="space-y-2 text-left w-full">
                            <h5 className="text-xs font-bold text-zinc-850">Salon Booking QR Code</h5>
                            <p className="text-[10px] text-zinc-400 leading-normal">
                              Display or print this QR code in your salon/spa. Clients can scan it using any mobile device to immediately book sessions in your scheduling portal.
                            </p>
                    ...
                    <form onSubmit={handleUpdateProfile} className="space-y-4">
                      ...
                      <div className="grid gap-4 sm:grid-cols-2">
                        <label className="block">
                          <span className="text-[10px] font-bold text-zinc-400 uppercase pl-1">Stylist/Therapist Name</span>
                          <input
                            type="text"
                            value={profileName}
                      ...
                      <div className="grid gap-4 sm:grid-cols-2">
                        ...
                        <label className="block">
                          <span className="text-[10px] font-bold text-zinc-400 uppercase pl-1">Salon Capacity</span>
                          <select
                ...
                {settingsSubTab === "locations" && (
                  <MultiLocationSettings
                    ...
                    professionLabels={{
                      ...
                      sectionDescription: "Create login credentials for each salon/spa branch. Each location can log in with its own email and password to manage its bookings via the workspace dashboard.",
                ...
                <div className="flex-1 p-5 sm:p-6 space-y-4 text-left overflow-y-auto min-h-0">
                  ...
                  {bookingStep === 3 && (
                    <div className="space-y-4 animate-fade-in">
                      ...
                      {/* Symptoms / Reason */}
                      <div className="space-y-1">
                        <label className="text-[10px] font-bold text-zinc-400 uppercase pl-1">Reason for Visit / Client Requests</label>
                        <div className="relative">
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/45 backdrop-blur-sm p-4 overflow-y-auto">
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-4 text-xs">
                ...
                <div>
                  <span className="text-[9px] font-bold text-zinc-400 uppercase tracking-wider block mb-0.5">Assigned Stylist</span>
                  <p className="text-zinc-700 font-bold">
              ...
              {selectedAptDetails.reason && (
                <div className="bg-zinc-50/30 border border-zinc-150 p-3 rounded-2xl">
                  <span className="text-[9px] font-bold text-zinc-400 uppercase tracking-wider block mb-1">Client Requests</span>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5 text-xs text-left">
                      ...
                      <div className="space-y-4">
                        <div className="space-y-1 bg-white p-3.5 border border-zinc-150 rounded-xl">
                          <span className="text-[9px] font-extrabold text-zinc-400 uppercase tracking-wider block">Client Requests</span>
