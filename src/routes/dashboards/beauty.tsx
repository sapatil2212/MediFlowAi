...
function BeautyDashboardPage() {
  ...
  const [servicePlanTreatments, setServicePlanTreatments] = useState<
  ...
  // ──────────────────────────────────────────────
  // 2. Stylist/Therapist Scribe Logic
  // ──────────────────────────────────────────────
  useEffect(() => {
    if (isRecording) {
  ...
  const handleExportConsultations = (format: "pdf" | "word" | "excel") => {
    try {
      ...
      if (format === "excel") {
        ...
        // Build table data
        const tableHeaders = [["Patient Info", "Date & Time", "Client Requests", "Status"]];
  ...
  const handleAIAssist = async () => {
    if (!consultationChiefComplaint.trim()) {
      showToast("error", "Please enter a Client Requests before using AI Assist.");
      return;
    }
              ...
              >
                ...
                <div className="text-left hidden sm:block">
                  ...
                  <p className="text-[10px] text-zinc-400 leading-tight truncate max-w-[80px]">
                    {user?.role === "admin" ? "Salon Admin" : user?.role || "Stylist"}
                  </p>
                </div>
                        ...
                        <div className="space-y-4">
                          ...
                          {showAddServiceModal && (
                            <div className="rounded-2xl border border-brand/20 bg-brand/5 p-4 space-y-3 text-xs">
                              ...
                              <div className="grid grid-cols-1 gap-3">
                                ...
                                <div className="space-y-1">
                                  <label className="text-[9px] font-bold uppercase text-zinc-400 tracking-wider block">
                                    Stylist/Therapist Observations
                                  </label>
                                  <textarea
                                    rows={2}
                          ...
                          {patientChartData === null ? (
                            ...
                            <div className="py-12 text-center text-zinc-400 italic text-xs">
                              No service or styling notes logged yet. Click "Add Service Record" to
                              get started.
                            </div>
                          ) : (
                            <div className="space-y-4">
                      ...
                      {patientProfileTab === "prescriptions" && (
                        <div className="space-y-4">
                                    ...
                                    <div className="col-span-1 flex items-center justify-center">
                                      {servicePlanTreatments.length > 1 && (
                                        <button
                                          type="button"
                                          onClick={() =>
                                            setServicePlanTreatments(
                                              servicePlanTreatments.filter((_, i) => i !== tIdx),
                                            )
                                          }
                          ...
                          {patientChartData === null ? (
                            ...
                            <div className="py-12 text-center text-zinc-400 italic text-xs">
                              No service or styling plans mapped to this client profile. Click "Add
                              Service Plan" to create one.
                            </div>
                          ) : (
                            <div className="space-y-6">
                      ...
                      {loadingStats
                        ...
                        : [
                            ...
                            },
                            {
                              ...
                              value: `${dashboardStats?.totalPatients || 0} Clients`,
                        ...
                        <div className="flex items-center justify-between">
                          <div>
                            ...
                            <p className="text-[10px] text-zinc-400 mt-0.5">
                              Client treatment volume over time
                            </p>
                          </div>
                        ...
                        >
                          ...
                          >
                            ...
                            <div className="space-y-1 sm:col-span-2">
                              <label className="text-[10px] font-bold text-zinc-400 uppercase">
                                Primary Goal / Style Preference
                              </label>
                              <input
                                type="text"
                                value={newPatientReason}
                                onChange={(e) => setNewPatientReason(e.target.value)}
                                placeholder="Hair styling, skincare, massage, bridal makeup, etc."
                                className="w-full rounded-full border border-zinc-200 bg-white px-3.5 py-1.5 text-xs focus:outline-none focus:border-brand font-semibold"
                                required
                              />
                            </div>
                            <div className="space-y-1 sm:col-span-2">
                              ...
                              <input
                                ...
                                placeholder="Skin allergies, hair type, product sensitivities, etc."
                                className="w-full rounded-full border border-zinc-200 bg-white px-3.5 py-1.5 text-xs focus:outline-none focus:border-brand font-semibold"
                              />
                            </div>
                                ...
                                <table className="min-w-full divide-y divide-zinc-200 text-left">
                                  <thead className="bg-zinc-50 text-[10px] font-bold text-zinc-400 uppercase">
                                    <tr>
                                      ...
                                      <th className="px-6 py-3">Service / Goal</th>
                                    ...
                                    {confirmedApts.map((apt) => (
                                      ...
                                      >
                                        ...
                                        <td className="px-6 py-3.5 max-w-[200px] truncate text-zinc-550 font-medium">
                                          {apt.reason || "General beauty service"}
                                        </td>
                                        ...
                                        <button
                                          ...
                                          onClick={() => {
                                            setConfirmDialog({
                                              open: true,
                                              title: "Delete Client File?",
                                              message: `Are you sure you want to delete ${p.name}'s client record? This will also purge all linked service history and beauty preferences.`,
                                              onConfirm: async () => {
                                                try {
                          ...
                          if (appointments.length === 0) {
                            return (
                              <div className="p-8 text-center text-zinc-400 font-semibold text-xs">
                                No salon appointments found matching constraints.
                              </div>
                            );
                          }
                  ...
                  >
                    ...
                    <div className="border-b border-zinc-100 pb-4">
                      <h3 className="text-base font-bold text-zinc-900 leading-none">
                        Workspace & Salon/Spa Management
                      </h3>
                      <p className="text-[10px] text-zinc-400 mt-1.5 leading-relaxed">
                        Configure salon/spa profiles, working hours, service categories, staff
                    ...
                    {(() => {
                      const tabs = [
                        { id: "profile", label: "Salon/Spa Profile", icon: Building2 },
                        { id: "hours", label: "Working Hours", icon: Clock },
                        { id: "departments", label: "Service Categories", icon: LayoutDashboard },
                        { id: "doctors", label: "Stylists & Therapists", icon: Stethoscope },
                        ...
                        <div className="space-y-6 animate-in fade-in duration-300">
                              ...
                              <div className="flex flex-col sm:flex-row items-center gap-4 p-4 rounded-2xl bg-zinc-50 border border-zinc-150">
                                ...
                                <div className="space-y-2 text-left w-full">
                                  <h5 className="text-xs font-bold text-zinc-850">
                                    Salon Booking QR Code
                                  </h5>
                                  <p className="text-[10px] text-zinc-400 leading-normal">
                                    Display or print this QR code in your salon/spa. Clients can
                                    scan it using any mobile device to immediately book sessions in
                          ...
                          <form onSubmit={handleUpdateProfile} className="space-y-4">
                            <div className="flex items-center gap-2">
                              <User className="h-4 w-4 text-brand" />
                              <h4 className="text-[10px] font-bold text-zinc-400 uppercase tracking-wider">
                                Stylist/Therapist Profile details
                              </h4>
                            </div>
                            ...
                            <div className="grid gap-4 sm:grid-cols-2">
                              <label className="block">
                                ...
                                <input
                                  ...
                                  placeholder="Dr. Stylist/Therapist"
                                  required
                    ...
                    {settingsSubTab === "departments" && (
                      <div className="space-y-6 animate-in fade-in duration-300">
                        ...
                        <form onSubmit={handleCreateDept} className="flex gap-2">
                          <input
                            type="text"
                            placeholder="Service category name (e.g. Hair Care)"
                            value={newDeptName}
                              ...
                              <tbody className="divide-y divide-zinc-150 text-xs">
                                ...
                                {departments.length === 0 && (
                                  <tr>
                                    ...
                                    >
                                      No service categories registered. Add one above.
                                    </td>
                                  </tr>
                                )}
                              </tbody>
                    ...
                    {settingsSubTab === "locations" && (
                      <MultiLocationSettings
                        ...
                        professionLabels={{
                          sectionTitle: "Multi-Location Salons & Spas",
                          sectionDescription:
                            "Create login credentials for each salon/spa branch. Each location can log in with its own email and password to manage its bookings via the workspace dashboard.",
                          singular: "Salon Location",
                        }}
                      />
                    )}
                ...
                <div className="flex-1 p-5 sm:p-6 space-y-4 text-left overflow-y-auto min-h-0">
                  ...
                  {bookingStep === 3 && (
                    <div className="space-y-4 animate-fade-in">
                      ...
                      <div className="space-y-1">
                        <label className="text-[10px] font-bold text-zinc-400 uppercase pl-1">
                          Reason for Visit / Client Requests
                        </label>
                        <div className="relative">
