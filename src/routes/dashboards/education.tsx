...
function EducationDashboardPage() {
  ...
  const [docSubjectsTaught, setDocSubjectsTaught] = useState("");
  ...
  const handleStep3Next = () => {
    ...
    const newErrs: Record<string, string> = {};
    if (!aptDeptId) {
      newErrs.dept = "Subject is required.";
    }
    if (!aptDateTime) {
      newErrs.date = "Appointment Date is required.";
    }
    if (!aptReason.trim()) {
      newErrs.reason = "Purpose of visit is required.";
    }
  ...
  const handleCreateOrUpdateAppointment = async (e: React.FormEvent) => {
    ...
    const newErrs: Record<string, string> = {};
    if (!aptName.trim()) {
      newErrs.name = "Student / Visitor Name is required.";
    }
    if (!aptEmail.trim() || !/\S+@\S+\.\S+/.test(aptEmail)) {
      newErrs.email = "Please enter a valid email address.";
    }
      ...
      if (editingApt) {
        ...
        const res = await updateAppointmentServerFn({
          data: {
            ...
            reason: aptReason,
            status: aptStatus,
            doctorId: aptDoctorId || undefined,
            timeSlot: undefined,
    ...
    getCurrentUserServerFn()
      .then((res) => {
        if (!res) {
          ...
          if (res.profession !== "Education institutions") {
  ...
  const handleOpenEditDoctor = (doc: any) => {
    ...
    setDocJoiningDate(doc.joiningDate || "");
    setDocSubjectsTaught(doc.subjectsTaught || "");
    ...
    try {
      const res = await saveDoctorServerFn({
        data: {
          ...
          joiningDate: docJoiningDate,
          subjectsTaught: docSubjectsTaught,
          departmentId: docDeptId,
        },
      });
      if (res.success) {
        setDocSuccess(
          editingDoc ? "Teacher profile updated successfully!" : "Teacher registered successfully!",
        );
      ...
      setDocError(err.message || "Failed to save teacher details.");
    } finally {
      setSavingDoc(false);
    }
  };
  ...
  const handleViewProfileForApt = async (apt: any) => {
    ...
    // Fallback student profile object for education
    setSelectedPatient({
      id: apt.patientId || apt.id,
      name: apt.name,
      email: apt.email || "",
  ...
  const handleExportConsultations = (format: "pdf" | "word" | "excel") => {
    try {
      ...
      if (format === "excel") {
        ...
        // Build table data
        const tableHeaders = [["Patient Info", "Date & Time", "Purpose of Visit", "Status"]];
  ...
  const handleAIAssist = async () => {
    if (!consultationChiefComplaint.trim()) {
      showToast("error", "Please enter a Purpose of Visit before using AI Assist.");
      return;
    }
  ...
  return (
    <div className="flex h-screen w-full overflow-hidden bg-zinc-50 font-sans text-zinc-900 relative">
          ...
          <>
            ...
            >
              <div className="space-y-6">
                ...
                <nav className="space-y-1">
                  {[
                    ...
                    { id: "patients", label: "Students Record", icon: Users },
              ...
              <div className="space-y-3">
                {/* Teacher Card — clickable opens profile modal */}
                <button
                  type="button"
                  onClick={() => {
                    setActiveTab("settings");
              ...
              >
                ...
                <div className="text-left hidden sm:block">
                  <p className="text-xs font-bold text-zinc-900 leading-tight truncate max-w-[80px]">
                    {user?.name ? user.name.split(" ")[0] + "." : "Educator."}
                  </p>
                  <p className="text-[10px] text-zinc-400 leading-tight truncate max-w-[80px]">
                    {user?.role === "admin" ? "Academy Admin" : user?.role || "Teacher"}
                  </p>
                </div>
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-zinc-200 pb-4">
                  ...
                  <div>
                    ...
                    >
                      <Edit3 className="h-3.5 w-3.5 text-zinc-500" /> Edit Student Registry
                    </button>
                  </div>
                </div>
                        ...
                        <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                  <div className="space-y-1">
                                    ...
                                    <textarea
                                      ...
                                      onChange={(e) =>
                                        setMeetingPerformanceAssessment(e.target.value)
                                      }
                                      className="w-full rounded-xl border border-zinc-200 bg-white px-3 py-2 text-xs text-zinc-800 placeholder:text-zinc-400 focus:outline-none focus:border-brand transition-all resize-none"
                                    />
                                  </div>
                          ...
                          {patientChartData === null ? (
                            ...
                            <div className="py-12 text-center text-zinc-400 italic text-xs">
                              No advising or meeting notes logged yet. Click "Add Advisory Note" to
                              get started.
                            </div>
                          ) : (
                            <div className="space-y-4">
                      ...
                      {patientProfileTab === "prescriptions" && (
                        <div className="space-y-4">
                                        ...
                                        <button
                                          ...
                                          onClick={() =>
                                            setStudyPlanSubjects(
                                              studyPlanSubjects.filter((_, i) => i !== subIdx),
                                            )
                                          }
                          ...
                          {patientChartData === null ? (
                            ...
                            <div className="py-12 text-center text-zinc-400 italic text-xs">
                              No study plans mapped to this student profile. Click "Add Study Plan"
                              to create one.
                            </div>
                          ) : (
                            <div className="space-y-6">
                      ...
                      {loadingStats
                        ...
                        : [
                            ...
                            },
                            {
                              ...
                              value: `${dashboardStats?.totalPatients || 0} Students`,
                        ...
                        <div className="flex items-center justify-between">
                          <div>
                            ...
                            <p className="text-[10px] text-zinc-400 mt-0.5">
                              Student class session volume over time
                            </p>
                          </div>
                ...
                {activeTab === "patients" && (
                  ...
                  >
                    <div className="flex items-center justify-between gap-4 flex-wrap">
                      ...
                      >
                        <Plus className="h-4 w-4" /> Add Student File
                      </button>
                    </div>
                        ...
                        >
                          ...
                          >
                            <div className="sm:col-span-4 font-bold text-xs text-zinc-800 border-b border-zinc-100 pb-2 mb-2">
                              {editingPatient
                                ? `Edit Student Registry File (${editingPatient.patientNo})`
                                : "Create New Student Registry File"}
                            </div>
                            <div className="space-y-1">
                            ...
                            <div className="space-y-1 sm:col-span-2">
                              <label className="text-[10px] font-bold text-zinc-400 uppercase">
                                Primary Goal / Learning Need
                              </label>
                              <input
                                type="text"
                                value={newPatientReason}
                                onChange={(e) => setNewPatientReason(e.target.value)}
                                placeholder="Math tutoring, reading comprehension, exam prep, etc."
                                className="w-full rounded-full border border-zinc-200 bg-white px-3.5 py-1.5 text-xs focus:outline-none focus:border-brand font-semibold"
                                required
                              />
                            </div>
                            <div className="space-y-1 sm:col-span-2">
                              <label className="text-[10px] font-bold text-zinc-400 uppercase">
                                Academic History / Notes
                              </label>
                              <input
                                type="text"
                                value={newPatientNotes}
                                onChange={(e) => setNewPatientNotes(e.target.value)}
                                placeholder="Past grades, learning preferences, etc."
                                className="w-full rounded-full border border-zinc-200 bg-white px-3.5 py-1.5 text-xs focus:outline-none focus:border-brand font-semibold"
                              />
                            </div>
                                    ...
                                    {confirmedApts.map((apt) => (
                                      ...
                                      >
                                        ...
                                        <td className="px-6 py-3.5 max-w-[200px] truncate text-zinc-550 font-medium">
                                          {apt.reason || "General academic session"}
                                        </td>
                                        ...
                                        <td className="px-6 py-3.5 text-right">
                                          <div className="flex items-center justify-end gap-1.5">
                                            ...
                                            <button
                                              type="button"
                                              title="Register / Edit Student File"
                                              onClick={() => {
                                                const pid = resolvePatientForApt(apt);
                        ...
                        <>
                          ...
                          <div className="hidden md:block">
                            <table className="min-w-full divide-y divide-zinc-200 text-left">
                              <thead className="bg-zinc-50 text-[10px] font-bold text-zinc-400 uppercase">
                                <tr>
                                  <th className="px-6 h-10">Student ID</th>
                                        ...
                                        <button
                                          ...
                                          onClick={() => {
                                            setConfirmDialog({
                                              open: true,
                                              title: "Delete Student File?",
                                              message: `Are you sure you want to delete ${p.name}'s student record? This will also purge all linked academic history and study plans.`,
                                              onConfirm: async () => {
                                                try {
                                                  ...
                                                  if (res.success) {
                                                    showToast(
                                                      "success",
                                                      "Student registry file deleted successfully.",
                                                    );
                                                    fetchPatients();
                                                  }
                                                } catch (err: any) {
                          ...
                          if (appointments.length === 0) {
                            return (
                              <div className="p-8 text-center text-zinc-400 font-semibold text-xs">
                                No academic sessions found matching constraints.
                              </div>
                            );
                          }
                  ...
                  >
                    ...
                    <div className="border-b border-zinc-100 pb-4">
                      <h3 className="text-base font-bold text-zinc-900 leading-none">
                        Workspace & Academy Management
                      </h3>
                      <p className="text-[10px] text-zinc-400 mt-1.5 leading-relaxed">
                        Configure academy profiles, working hours, subject categories, educator
                    ...
                    {(() => {
                      const tabs = [
                        { id: "profile", label: "Academy Profile", icon: Building2 },
                              ...
                              <div className="flex flex-col sm:flex-row items-center gap-4 p-4 rounded-2xl bg-zinc-50 border border-zinc-150">
                                ...
                                <div className="space-y-2 text-left w-full">
                                  <h5 className="text-xs font-bold text-zinc-850">
                                    Academy Booking QR Code
                                  </h5>
                                  <p className="text-[10px] text-zinc-400 leading-normal">
                                    Display or print this QR code in your academy. Students can scan
                                    it using any mobile device to immediately book sessions in your
                                    scheduling portal.
                                  </p>
                    ...
                    {settingsSubTab === "departments" && (
                      <div className="space-y-6 animate-in fade-in duration-300">
                        ...
                        <form onSubmit={handleCreateDept} className="flex gap-2">
                          <input
                            type="text"
                            placeholder="Subject category name (e.g. Mathematics)"
                            value={newDeptName}
                              ...
                              <tbody className="divide-y divide-zinc-150 text-xs">
                                ...
                                {departments.length === 0 && (
                                  <tr>
                                    ...
                                    >
                                      No subject categories registered. Add one above.
                                    </td>
                                  </tr>
                                )}
                              </tbody>
                        ...
                        {selectedDocForSchedule ? (
                          ...
                          >
                            <div className="flex items-center justify-between border-b border-zinc-100 pb-2">
                              <h4 className="text-xs font-bold text-zinc-800 uppercase">
                                {editingDoc
                                  ? "Edit Teacher / Instructor Profile"
                            ...
                            <label className="block">
                              ...
                              <input
                                type="text"
                                value={docSubjectsTaught}
                                onChange={(e) => setDocSubjectsTaught(e.target.value)}
                            ...
                            <div className="flex justify-end gap-2 border-t border-zinc-100 pt-3">
                              ...
                              >
                                ...
                                {editingDoc ? "Update Teacher" : "Register Teacher"}
                              </button>
                            </div>
                          </form>
                        ) : (
                          ...
                          <div className="space-y-4">
                            <div className="flex justify-end">
                              ...
                              >
                                <Plus className="h-3.5 w-3.5" /> Add Teacher / Instructor
                              </button>
                            </div>
                              ...
                              <div className="grid gap-4 md:grid-cols-2">
                                ...
                                {doctors.length === 0 && (
                                  <div className="md:col-span-2 rounded-2xl border border-dashed border-zinc-250 p-8 text-center text-zinc-400 font-semibold">
                                    No teachers registered. Add a teacher / instructor profile
                                    above.
                                  </div>
                                )}
                              </div>
                    ...
                    {settingsSubTab === "locations" && (
                      <MultiLocationSettings
                        ...
                        professionLabels={{
                          ...
                          sectionDescription:
                            "Create login credentials for each academy branch. Each location can log in with its own email and password to manage its bookings via the workspace dashboard.",
                ...
                <div className="flex-1 p-5 sm:p-6 space-y-4 text-left overflow-y-auto min-h-0">
                    ...
                    <div className="space-y-4 animate-fade-in">
                                  ...
                                  {getDaysInMonth(calMonth, calYear).map((day, idx) => {
                                    ...
                                    return (
                                      <button
                                        ...
                                        onClick={() => {
                                          if (past) return;
                                          setAptDateTime(localDateStr + "T09:00");
                                          setAptCalendarOpen(false);
                                          if (fieldErrors.date)
                      ...
                      <div className="space-y-1">
                        ...
                        <div className="relative">
                          ...
                          <input
                            type="text"
                            placeholder="e.g. academic counselling, exam inquiry, subject query"
                            value={aptReason}
                            onChange={(e) => {
                  ...
                  <div className="space-y-1 relative dropdown-container">
                    ...
                    <div className="relative">
                      ...
                      >
                        <span
                          className={aptDeptId ? "font-semibold text-zinc-800" : "text-zinc-400"}
                        >
                          {aptDeptId
                            ? departments.find((d) => d.id === aptDeptId)?.name
                            : "Select Department"}
                  ...
                  <div className="space-y-1 relative dropdown-container">
                    ...
                    <div className="relative">
                      ...
                      >
                        <span
                          className={aptDoctorId ? "font-semibold text-zinc-800" : "text-zinc-400"}
                        >
                          {aptDoctorId
                  ...
                  <div className="space-y-1 relative dropdown-container">
                    ...
                    <div className="relative">
                      ...
                      >
                        <Calendar className="absolute left-3.5 top-2.5 h-4 w-4 text-zinc-455" />
                        <span
                          className={aptDateTime ? "font-semibold text-zinc-800" : "text-zinc-400"}
                        >
                          {aptDateTime
                            ? new Date(aptDateTime).toLocaleDateString("en-US", {
                                weekday: "short",
                        ...
                        <div className="grid gap-3 sm:grid-cols-2 text-[11px] text-left">
                          <div className="space-y-1">
                            <span className="text-[9px] font-bold text-zinc-400 uppercase block font-semibold">
                              Student / Visitor Info
                            </span>
                            <p className="font-bold text-zinc-700">{aptName}</p>
                            <p className="text-zinc-500 font-semibold">
                              {aptGender} •{" "}
                              {aptDob ? `DOB: ${aptDob} (${calculateAge(aptDob)} yrs)` : "No DOB"}
                            </p>
                          </div>
                          ...
                          <div className="space-y-1 sm:col-span-2 border-t border-zinc-200/60 pt-2">
                            ...
                            <p className="font-semibold text-zinc-700">
                              Subject: {departments.find((d) => d.id === aptDeptId)?.name || "—"}
                            </p>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/45 backdrop-blur-sm p-4 overflow-y-auto">
            ...
            >
              ...
              <div className="flex items-center gap-3 pb-3 border-b border-zinc-100">
                ...
                <div>
                  <h3 className="text-sm font-bold text-zinc-900 leading-none">Booking Details</h3>
                  <span className="text-[10px] text-zinc-400 mt-1.5 block font-semibold">
              ...
              <div className="grid grid-cols-2 gap-4 text-xs">
                ...
                <div>
                  ...
                  <span
                    className={`inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[9px] font-bold shadow-none border leading-none ${
                ...
                <div className="col-span-2">
                  ...
                  <p className="text-zinc-700 font-bold">
                    {departments.find(
                      (d) =>
                        d.id ===
                        (selectedAptDetails.departmentId ||
              ...
              <div className="pt-2 grid grid-cols-2 gap-2">
                <button
                  ...
                  className="inline-flex items-center justify-center gap-1 border border-zinc-200 bg-white hover:bg-zinc-50 text-zinc-700 font-bold text-xs py-2.5 rounded-full transition-all active:scale-[0.98] cursor-pointer"
                >
                ...
                <button
                  ...
                  className="inline-flex items-center justify-center gap-1 border border-red-200 bg-red-50/20 hover:bg-red-50 text-red-655 font-bold text-xs py-2.5 rounded-full transition-all active:scale-[0.98] cursor-pointer"
                >
      ...
      {/* Generic Confirmation Modal (used for Students, WhatsApp, etc.) */}
      <AnimatePresence>
