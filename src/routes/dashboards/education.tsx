...
function EducationDashboardPage() {
  ...
  const handleSaveDoctor = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.success) {
        setDocSuccess(editingDoc ? "Teacher profile updated successfully!" : "Teacher registered successfully!");
  ...
  const handleExportConsultations = (format: "pdf" | "word" | "excel") => {
    try {
      ...
      if (format === "excel") {
        const headers = ["Student Name", "Age", "Gender", "Phone", "Email", "Date & Time", "Purpose of Visit", "Status"];
                        ...
                        >
                          <div className="space-y-2">
                            ...
                            <div className="grid grid-cols-2 gap-2 text-[10px] text-zinc-500 font-semibold leading-relaxed">
                              ...
                              <div>
                                <span className="text-zinc-400 block text-[8px] uppercase font-bold tracking-wider">Assigned Teacher</span>
                            ...
                            {apt.reason && (
                              <div className="bg-zinc-50/50 p-2 rounded-lg border border-zinc-150/40">
                                <span className="text-zinc-400 block text-[8px] uppercase font-bold tracking-wider">Purpose of Visit</span>
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-zinc-200 pb-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-[10px] text-zinc-450 font-mono mt-0.5">Student ID: {patientDetails.id}</p>
                      </div>
                    </div>
                    ...
                    <div className="lg:col-span-1 space-y-4">
                      <div className="rounded-2xl border border-zinc-200/80 bg-white p-5 space-y-4 shadow-sm">
                        ...
                        <div className="space-y-3.5 text-xs text-left">
                          ...
                          <div>
                            <span className="text-zinc-400 block text-[9px] font-bold uppercase tracking-tight">Admitted Date</span>
                ...
                <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                  {loadingStats ? (
                    ...
                    [
                      ...
                      { label: "Total Active Students", value: `${dashboardStats?.totalPatients || 0} Students`, info: "Registered in directory", icon: Users, color: "text-amber-600 bg-amber-50 border-amber-100" },
                  ...
                  <div className="rounded-2xl border border-zinc-200 bg-white p-5 space-y-4">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-[10px] text-zinc-400 mt-0.5">Student class session volume over time</p>
                      </div>
                    ...
                    >
                      <form onSubmit={handleAddPatientSubmit} className="rounded-2xl border border-zinc-200 bg-white p-5 grid gap-4 sm:grid-cols-4 items-end">
                        <div className="sm:col-span-4 font-bold text-xs text-zinc-800 border-b border-zinc-100 pb-2 mb-2">
                          {editingPatient ? `Edit Student Registry File (${editingPatient.patientNo})` : "Create New Student Registry File"}
                        </div>
                        <div className="space-y-1">
                          <label className="text-[10px] font-bold text-zinc-400 uppercase">Student Name</label>
                          <input
                            type="text"
                        ...
                        <div className="space-y-1 sm:col-span-2">
                          <label className="text-[10px] font-bold text-zinc-400 uppercase">Primary Goal / Learning Need</label>
                          <input
                            type="text"
                        ...
                        <div className="space-y-1 sm:col-span-2">
                          <label className="text-[10px] font-bold text-zinc-400 uppercase">Academic History / Notes</label>
                          <input
                            type="text"
                        ...
                        <div className="sm:col-span-4 flex justify-end gap-2">
                          ...
                          >
                            ...
                            {editingPatient ? "Update Student Profile" : "Create Student Profile"}
                          </button>
                        </div>
                      </form>
                    </motion.div>
                  ...
                  {loadingPatients ? (
                    ...
                    <div className="space-y-6">
                      <div className="p-8 text-center bg-white rounded-2xl">
                        ...
                        <p className="text-xs text-zinc-400 font-bold">No student profiles match your query.</p>
                      </div>
                              ...
                              {confirmedApts.map((apt) => (
                                <div key={apt.id} className="bg-white border border-zinc-200/80 rounded-xl p-4 flex flex-col justify-between hover:shadow-sm transition-all">
                                  ...
                                  <div className="border-t border-zinc-100 mt-3 pt-2 flex items-center justify-between text-[10px] text-zinc-500">
                                    ...
                                    <span className="truncate max-w-[120px] font-semibold text-zinc-700">{apt.reason || "General academic session"}</span>
                                  </div>
                                </div>
                              ))}
                            </div>
                                        ...
                                        setConfirmDialog({
                                          ...
                                          onConfirm: async () => {
                                            try {
                                              ...
                                              if (res.success) {
                                                showToast("success", "Student registry file deleted successfully.");
                                                fetchPatients();
                                              }
                                            } catch (err: any) {
                          ...
                          <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                            <div>
                              <p className="text-[11px] text-zinc-500 font-medium">
                                ...
                                <span className="font-bold text-zinc-800">{patientsTotal}</span> students
                              </p>
                            </div>
                            <div>
                                            ...
                                            if (pid) {
                                              ...
                                              if (matched) {
                                                ...
                                                try {
                                                  ...
                                                  console.error("Failed to load student chart:", e);
                                              ...
                                              showToast("error", "No student profile found for this booking.");
                                            }
                                          }}
                                  ...
                                  <button
                                    ...
                                    onClick={async () => {
                                      ...
                                      if (pid) {
                                        ...
                                        showToast("error", "No student profile found.");
                                      }
                                    }}
                                    className="text-brand font-bold text-xs cursor-pointer mr-auto"
                                  >
              ...
              >
                ...
                <div className="border-b border-zinc-100 pb-4">
                  ...
                  <p className="text-[10px] text-zinc-400 mt-1.5 leading-relaxed">
                    Configure academy profiles, working hours, subject categories, educator schedules, and WhatsApp alerts.
                  </p>
                </div>
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-4 p-4 rounded-2xl bg-zinc-50 border border-zinc-150">
                          ...
                          <div className="space-y-2 text-left w-full">
                            <h5 className="text-xs font-bold text-zinc-850">Academy Booking QR Code</h5>
                            <p className="text-[10px] text-zinc-400 leading-normal">
                              Display or print this QR code in your academy. Students can scan it using any mobile device to immediately book sessions in your scheduling portal.
                            </p>
                    ...
                    <form onSubmit={handleUpdateProfile} className="space-y-4">
                      ...
                      <div className="grid gap-4 sm:grid-cols-2">
                        <label className="block">
                          <span className="text-[10px] font-bold text-zinc-400 uppercase pl-1">Teacher Name</span>
                          <input
                            type="text"
                            value={profileName}
                      ...
                      <div className="grid gap-4 sm:grid-cols-2">
                        ...
                        <label className="block">
                          <span className="text-[10px] font-bold text-zinc-400 uppercase pl-1">Student Capacity</span>
                          <select
                          ...
                          <form onSubmit={handleSaveDoctor} className="space-y-4 border border-zinc-150 bg-zinc-50 rounded-2xl p-5 animate-in fade-in duration-300">
                            <div className="flex items-center justify-between border-b border-zinc-100 pb-2">
                              <h4 className="text-xs font-bold text-zinc-800 uppercase">
                                {editingDoc ? "Edit Teacher / Instructor Profile" : "Add Teacher / Instructor"}
                              </h4>
                              <button
                                type="button"
                                onClick={() => {
                            ...
                            <div className="grid gap-4 sm:grid-cols-2">
                              ...
                              <label className="block">
                                <span className="text-[10px] font-bold text-zinc-400 uppercase pl-1">Employee / Staff ID</span>
                                <input
                                  type="text"
                                  value={docEmployeeId}
                            ...
                            <div className="grid gap-4 sm:grid-cols-2">
                              <label className="block">
                                <span className="text-[10px] font-bold text-zinc-400 uppercase pl-1">Designation</span>
                                <select
                              ...
                              <label className="block">
                                <span className="text-[10px] font-bold text-zinc-400 uppercase pl-1">Subject / Department Assignment</span>
                                <select
                                  value={docDeptId}
                            ...
                            <div className="grid gap-4 sm:grid-cols-2">
                              ...
                              <label className="block">
                                <span className="text-[10px] font-bold text-zinc-400 uppercase pl-1">Joining Date</span>
                                <input
                                  type="date"
                            ...
                            <label className="block">
                              <span className="text-[10px] font-bold text-zinc-400 uppercase pl-1">Subjects Taught</span>
                              <input
                                type="text"
                              ...
                              <div className="grid gap-4 md:grid-cols-2">
                                      ...
                                      <div className="flex items-start justify-between">
                                        <div>
                                          ...
                                          <span className="text-[9px] font-bold text-brand bg-brand/5 border border-brand/10 rounded-full px-2.5 py-0.5 mt-1 inline-block">
                                            {doc.designation || doc.departmentName || "Teaching Staff"}
                                          </span>
                                        </div>
                                        <div className="flex gap-1.5">
                                          <button
                                ...
                                {doctors.length === 0 && (
                                  <div className="md:col-span-2 rounded-2xl border border-dashed border-zinc-250 p-8 text-center text-zinc-400 font-semibold">
                                    No teachers registered. Add a teacher / instructor profile above.
                                  </div>
                                )}
                              </div>
                            )}
                    ...
                    {[
                      {
                        ...
                        features: ["1 teacher dashboard", "500 appointments / mo", "Up to 500 student records", "AI study plans standard"],
                        action: "Selected",
                      ...
                      },
                      {
                        ...
                        features: ["Up to 5 teachers", "2,000 appointments / mo", "Up to 5,000 student records", "WhatsApp alerts included", "Receptionist dashboard"],
                        action: "Upgrade",
                ...
                <div className="flex-1 p-5 sm:p-6 space-y-4 text-left overflow-y-auto min-h-0">
                  ...
                  {bookingStep === 1 && (
                    <div className="space-y-4 animate-fade-in">
                      ...
                      <div className="space-y-1">
                        <label className="text-[10px] font-bold text-zinc-400 uppercase pl-1">Student / Visitor Full Name</label>
                  ...
                  {bookingStep === 3 && (
                    <div className="space-y-4 animate-fade-in">
                        ...
                        <div className="relative">
                          ...
                          >
                            <span className={aptDeptId ? "font-semibold text-zinc-800" : "text-zinc-400"}>
                              {aptDeptId ? departments.find(d => d.id === aptDeptId)?.name : "Select Subject"}
                            </span>
                      ...
                      <div className="space-y-1 relative dropdown-container">
                        <label className="text-[10px] font-bold text-zinc-400 uppercase pl-1">Select Date</label>
                        <div className="relative">
                          <button
                            type="button"
                            onClick={() => {
                                    ...
                                    return (
                                      <button
                                        ...
                                        className={`h-7 w-7 text-[10px] font-bold rounded-lg flex items-center justify-center transition-all ${
                                          isSelected ? "bg-brand text-white font-black"
                                            : past ? "text-zinc-200 cursor-not-allowed"
                      ...
                      {/* Purpose of Visit */}
                      <div className="space-y-1">
                        <label className="text-[10px] font-bold text-zinc-400 uppercase pl-1">Purpose of Visit</label>
                        <div className="relative">
                    ...
                    <div className="space-y-4 animate-fade-in">
                      ...
                      <div className="p-4 rounded-2xl border border-zinc-200/80 bg-zinc-50/50 space-y-3">
                        ...
                        <div className="grid gap-3 sm:grid-cols-2 text-[11px] text-left">
                          <div className="space-y-1">
                            <span className="text-[9px] font-bold text-zinc-400 uppercase block font-semibold">Student / Visitor Info</span>
                            <p className="font-bold text-zinc-700">{aptName}</p>
                            <p className="text-zinc-500 font-semibold">
                              {aptGender} • {aptDob ? `DOB: ${aptDob} (${calculateAge(aptDob)} yrs)` : "No DOB"}
                            </p>
                          </div>
                          ...
                          <div className="space-y-1 sm:col-span-2 border-t border-zinc-200/60 pt-2">
                            <span className="text-[9px] font-bold text-zinc-400 uppercase block font-semibold">Booking Details</span>
                            <p className="font-semibold text-zinc-700">
                              Subject: {departments.find(d => d.id === aptDeptId)?.name || "—"}
                            </p>
                            <p className="text-brand font-bold text-xs mt-0.5">
                              {aptDateTime ? new Date(aptDateTime).toLocaleDateString("en-US", { weekday: 'short', month: 'short', day: 'numeric', year: 'numeric' }) : "No date selected"}
                            </p>
                            <p className="text-zinc-500 mt-1 italic font-medium leading-relaxed">Purpose: {aptReason}</p>
                          </div>
                        </div>
                      </div>
                    </div>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/45 backdrop-blur-sm p-4 overflow-y-auto">
            ...
            >
              ...
              <div className="flex items-center gap-3 pb-3 border-b border-zinc-100">
                ...
                <div>
                  ...
                  <span className="text-[10px] text-zinc-400 mt-1.5 block font-semibold">
                    {new Date(selectedAptDetails.dateTime).toLocaleDateString("en-US", { weekday: "long", month: "long", day: "numeric", year: "numeric" })}
                  </span>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3.5 p-3 rounded-2xl bg-zinc-50 border border-zinc-150/60">
                ...
                <div className="space-y-0.5 min-w-0">
                  ...
                  {selectedAptDetails.email && (
                    <p className="text-[10px] text-zinc-400 font-semibold truncate">{selectedAptDetails.email}</p>
                  )}
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4 text-xs">
                <div>
                  <span className="text-[9px] font-bold text-zinc-400 uppercase tracking-wider block mb-0.5">Booking Date</span>
                ...
                <div>
                  <span className="text-[9px] font-bold text-zinc-400 uppercase tracking-wider block mb-0.5">Status</span>
                  <span className={`inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[9px] font-bold shadow-none border leading-none ${
                ...
                <div className="col-span-2">
                  <span className="text-[9px] font-bold text-zinc-400 uppercase tracking-wider block mb-0.5">Subject</span>
                  <p className="text-zinc-700 font-bold">
                    {departments.find(d => d.id === (selectedAptDetails.departmentId || doctors.find(doc => doc.id === selectedAptDetails.doctorId)?.departmentId))?.name || "—"}
                  </p>
                </div>
              </div>
              ...
              {selectedAptDetails.reason && (
                <div className="bg-zinc-50/30 border border-zinc-150 p-3 rounded-2xl">
                  <span className="text-[9px] font-bold text-zinc-400 uppercase tracking-wider block mb-1">Purpose of Visit</span>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5 text-xs text-left">
                      ...
                      <div className="space-y-4">
                        <div className="space-y-1 bg-white p-3.5 border border-zinc-150 rounded-xl">
                          <span className="text-[9px] font-extrabold text-zinc-400 uppercase tracking-wider block">Purpose of Visit</span>
