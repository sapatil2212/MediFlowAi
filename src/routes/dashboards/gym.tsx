                              ...
                              {confirmedApts.map((apt) => (
                                <div key={apt.id} className="bg-white border border-zinc-200/80 rounded-xl p-4 flex flex-col justify-between hover:shadow-sm transition-all">
                                  ...
                                  <div className="border-t border-zinc-100 mt-3 pt-2 flex items-center justify-between text-[10px] text-zinc-500">
                                    ...
                                    <span className="truncate max-w-[120px] font-semibold text-zinc-700">{apt.reason || "General training session"}</span>
                                  </div>
                                </div>
                              ))}
                            </div>
                    ...
                    {[
                      {
                        ...
                        features: ["1 trainer dashboard", "500 appointments / mo", "Up to 500 client records", "AI workout plans standard"],
                        action: "Selected",
                      ...
                      },
                      {
                        ...
                        features: ["Up to 5 trainers", "2,000 appointments / mo", "Up to 5,000 client records", "WhatsApp alerts included", "Receptionist dashboard"],
                        action: "Upgrade",
