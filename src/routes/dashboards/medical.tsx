...
export const Route = createFileRoute("/dashboards/medical")({
  head: () => ({
    meta: [
      { title: "Clinician Dashboard — BookMyTime" },
      {
        name: "description",
...
function MedicalDashboardPage() {
  ...
  const handleSubLocSave = async () => {
    setSubLocFormError("");
    if (!subLocForm.name.trim()) {
      setSubLocFormError("Patient name is required");
      return;
    }
    if (!subLocForm.locationId) {
      setSubLocFormError("Please select a location");
      return;
    }
    if (!subLocForm.dateTime) {
      setSubLocFormError("Please select a date & time");
      return;
    }
    if (!subLocForm.reason.trim()) {
      setSubLocFormError("Reason is required");
      return;
    }
  ...
  const analyzeSmartVoiceField = async (fieldName: string, transcript: string) => {
    ...
    try {
      ...
      if (fieldName === "chiefComplaint" && res.chiefComplaint) {
        setConsultationChiefComplaint((prev) =>
          prev ? `${prev} ${res.chiefComplaint}` : res.chiefComplaint!,
        );
  ...
  const toggleSmartVoiceForField = (
    fieldName: "chiefComplaint" | "diagnosis" | "medications" | "advice",
  ) => {
    if (recordingField === fieldName) {
      ...
      startSpeechRecognition((text) => {
        smartVoiceBufferRef.current += text;
      });
    }
  };
                  ...
                  {dayAppointments.slice(0, 3).map((apt) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {apt.tokenNo && (
                          <span className="text-zinc-450 font-black shrink-0">#{apt.tokenNo}</span>
                        )}
                ...
                <nav className="space-y-1">
                  {[
                    ...
                    .filter((tab) => {
                      ...
                      if (
                        tab.id === "subLocationBookings" &&
                        !(user?.role === "admin" && subLocations.length > 0)
                      )
                        return false;
                      return true;
                    })
                      ...
                      {loadingStats
                        ...
                        : [
                            ...
                            },
                            {
                              ...
                              value: `${dashboardStats?.totalPatients || 0} Patients`,
                            ...
                            {loadingStats ? (
                              ...
                              getTimelineEvents().map((evt: any, idx: number) => (
                                ...
                                >
                                  {/* Dot */}
                                  <div
                                    className={`absolute -left-[16.5px] top-1.5 h-2 w-2 rounded-full ring-4 ring-white ${evt.color}`}
                                  />
                                  <div
                                  ...
                                  >
                                    <div className="flex items-center justify-between">
                                      ...
                                      <span className="text-[9px] font-semibold text-zinc-400 flex items-center gap-0.5">
                                        Status:{" "}
                                        {evt.patientObj.status === "Pending Review"
                                          ? "Pending"
                                          : evt.patientObj.status}
                                      </span>
                                    </div>
                                    <h4 className="text-xs font-bold text-zinc-800">
                                      {evt.patient}
                  ...
                  >
                    {selectedAptForConsultation ? (
                                ...
                                patientChartData.soapNotes.length > 0 ? (
                                  patientChartData.soapNotes.map((note: any, idx: number) => (
                                    ...
                                    >
                                      ...
                                      <div>
                                        <span className="font-semibold text-zinc-500 text-[9px] uppercase tracking-wide block">
                                          Chief Complaint:
                                        </span>
                                        <span className="text-zinc-700 font-bold">
                                          {note.subjective}
                                  ...
                                  <div className="flex flex-col items-center justify-center py-8 text-center border border-dashed border-zinc-200 rounded-xl bg-zinc-50/30">
                                    ...
                                    <p className="text-[10px] text-zinc-400 mt-0.5 max-w-[220px]">
                                      This patient has no earlier consultation records. Saved
                                ...
                                >
                                  {analyzingField === "chiefComplaint" ? (
                                    ...
                                    <>
                                      ...
                                      {`Listening (${formatTime(recordingSeconds)}) — tap to fill`}
                                    </>
                                  ) : (
                                    <>
                            ...
                            <div className="rounded-2xl border border-zinc-150 bg-gradient-to-br from-emerald-50/15 via-white to-zinc-50/20 p-5 space-y-4 shadow-none text-left transition-all hover:border-zinc-200/80 duration-300">
                              ...
                              {prescriptionMedications.length > 0 ? (
                                ...
                                <div className="text-xs text-zinc-400 italic py-4 text-center border border-dashed border-zinc-200 rounded-xl bg-zinc-50/20">
                                  No medications prescribed. Click "Add Medication" below to add
                                  one.
                                </div>
                              )}
                              ...
                              {consultationLabTests.length > 0 ? (
                                <div className="space-y-3.5">
                                  {consultationLabTests.map((test, index) => (
                                    <div
                                      key={index}
                                      className="flex flex-col sm:flex-row gap-3 items-end sm:items-center bg-zinc-50/40 border border-zinc-150 p-3 rounded-xl relative"
                                    >
                      ...
                      >
                        ...
                        {/* 1. Statistics Bar */}
                        {(() => {
                          const isFollowUp = (reasonStr: string) =>
                            reasonStr && reasonStr.toLowerCase().includes("follow");
                              ...
                              <div className="rounded-2xl border border-zinc-200/80 bg-white p-4 flex items-center justify-between shadow-sm">
                                <div className="space-y-1">
                                  ...
                                  <h3 className="text-2xl font-extrabold text-zinc-900">
                                    {
                                      currentSubTabApts.filter(
                                        (a) =>
                                          matchDate(a.dateTime, todayStr) &&
                                          a.status !== "Cancelled",
                                      ).length
                                    }
                                  </h3>
                              ...
                              <div className="rounded-2xl border border-zinc-200/80 bg-white p-4 flex items-center justify-between shadow-sm">
                                <div className="space-y-1">
                                  ...
                                  <h3 className="text-2xl font-extrabold text-emerald-600">
                                    {
                                      currentSubTabApts.filter((a) => a.status === "Completed")
                                        .length
                                    }
                                  </h3>
                                </div>
                              ...
                              <div className="rounded-2xl border border-zinc-200/80 bg-white p-4 flex items-center justify-between shadow-sm">
                                <div className="space-y-1">
                                  ...
                                  <h3 className="text-2xl font-extrabold text-red-600">
                                    {
                                      currentSubTabApts.filter((a) => a.status === "Cancelled")
                                        .length
                                    }
                                  </h3>
                                </div>
                            ...
                            <div className="flex items-center gap-2 justify-end">
                              ...
                              <div className="relative">
                                ...
                                >
                                  ...
                                  Export{" "}
                                  {selectedAptIds.length > 0 ? `(${selectedAptIds.length})` : ""}
                          ...
                          {loadingAppointments ? (
                            ...
                            (() => {
                              ...
                              const list = appointments.filter((apt) => {
                                ...
                                const matchStatus =
                                  consultationStatus === "All" || apt.status === consultationStatus;
                                const matchDateFilter =
                                  consultationShowAll || matchDate(apt.dateTime, consultationDate);
                                const isFollowUp =
                                  apt.reason && apt.reason.toLowerCase().includes("follow");
                                const matchSubTab =
                                  consultationSubTab === "followups" ? isFollowUp : !isFollowUp;
                              ...
                              if (list.length === 0) {
                                return (
                                  <div className="rounded-xl border border-zinc-100 bg-zinc-50/20 py-16 text-center">
                                    ...
                                    <h4 className="text-xs font-bold text-zinc-805">
                                      No appointments found
                                    </h4>
                                    <p className="text-[10px] text-zinc-400 mt-1 max-w-[280px] mx-auto">
                                      Try adjusting the date, status, or search filters to find
                                  ...
                                  <table className="min-w-full divide-y divide-zinc-150 text-left">
                                    <thead className="bg-zinc-50 text-[10px] font-bold text-zinc-400 uppercase">
                                      {(() => {
                                        const allSelected =
                                          list.length > 0 &&
                                          list.every((apt) => selectedAptIds.includes(apt.id));
                        ...
                        >
                          ...
                          >
                            <div className="sm:col-span-4 font-bold text-xs text-zinc-800 border-b border-zinc-100 pb-2 mb-2">
                              {editingPatient
                                ? `Edit Patient Registry File (${editingPatient.patientNo})`
                                : "Create New Patient Registry File"}
                            </div>
                            <div className="space-y-1">
                      ...
                      {loadingPatients ? (
                        ...
                        <div className="p-8 text-center">
                          ...
                          <p className="text-xs text-zinc-400 font-bold">
                            No patient profiles match your query.
                          </p>
                        </div>
                      ) : (
                        <>
                                              ...
                                              onConfirm: async () => {
                                                try {
                                                  ...
                                                  if (res.success) {
                                                    showToast(
                                                      "success",
                                                      "Patient registry file deleted successfully.",
                                                    );
                                                    fetchPatients();
                                                  }
                                                } catch (err: any) {
                                                  showToast(
                                                    "error",
                                                    err.message || "Failed to delete patient",
                                                  );
                                                } finally {
                              ...
                              <div key={p.id} className="p-4 space-y-3">
                                <div className="flex justify-between items-start">
                                  <div>
                                    ...
                                    <h4 className="text-sm font-bold text-zinc-800 mt-1.5">
                                      {p.name}
                                    </h4>
                                  </div>
                                ...
                                <div className="space-y-1 text-xs border-t border-b border-zinc-100/70 py-2">
                                  <div className="flex items-center gap-1.5">
                                    <span className="text-zinc-400 font-semibold uppercase text-[9px] tracking-wide block w-24 shrink-0">
                                      Complaint:
                                    </span>
                          ...
                          <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                            <div>
                              <p className="text-[11px] text-zinc-500 font-medium">
                                ...
                                of <span className="font-bold text-zinc-800">{patientsTotal}</span>{" "}
                                patients
                              </p>
                            </div>
                            <div>
                    ...
                    {loadingAnalytics ? (
                      ...
                      <>
                        <div className="grid gap-6 md:grid-cols-2">
                          ...
                          <div className="rounded-2xl border border-zinc-200 bg-white p-5 space-y-4">
                            <div>
                              ...
                              <p className="text-[10px] text-zinc-400 mt-0.5">
                                Weekly patient booking distribution
                              </p>
                            </div>
                            ...
                            {(() => {
                              ...
                              const counts = daysOfWeek.map((day) => {
                                const match = analyticsData?.byDayOfWeek?.find(
                          ...
                          <div className="rounded-2xl border border-zinc-200 bg-white p-5 space-y-4">
                            <div>
                              ...
                              <p className="text-[10px] text-zinc-400 mt-0.5">
                                Highest volume clinical practitioners
                              </p>
                            </div>
                        ...
                        <div className="rounded-2xl border border-zinc-200 bg-white p-5 space-y-3">
                          <h4 className="text-xs font-bold text-zinc-800 uppercase tracking-tight">
                            BookMyTime efficiency scorecard
                          </h4>
                  ...
                  (() => {
                    ...
                    const filtered = subLocationBookings.filter((b) => {
                      if (
                        !isSubLocationUser &&
                        subLocFilter !== "all" &&
                        b.locationId !== subLocFilter
                      )
                        return false;
                      if (
                        subLocStatusFilter !== "all" &&
                        norm(b.status) !== norm(subLocStatusFilter)
                      )
                        return false;
                    ...
                    subLocationBookings.forEach((b) => {
                      counts[b.locationId] = (counts[b.locationId] || 0) + 1;
                    });
                          ...
                          <div className="flex flex-wrap gap-2">
                            ...
                            {subLocations.map((loc) => (
                              ...
                              >
                                ...
                                {loc.name}
                                {loc.city ? ` — ${loc.city}` : ""} ({counts[loc.id] || 0})
                              </button>
                            ))}
                          </div>
                        )}
                        ...
                        {loadingSubLocBookings ? (
                          ...
                          <div className="rounded-2xl border border-zinc-200 bg-white p-12 text-center space-y-2">
                            ...
                            <p className="text-sm font-bold text-zinc-400">
                              No sub-location bookings found
                            </p>
                            ...
                            <table className="w-full text-xs min-w-[760px]">
                              ...
                              <tbody className="divide-y divide-zinc-100">
                                {filtered.map((b) => {
                                  const dt = new Date(b.dateTime);
                                  const statusColor =
                                    norm(b.status) === "confirmed"
                                      ? "bg-emerald-50 text-emerald-600"
                                      : norm(b.status) === "completed"
                                  ...
                                  return (
                                    <tr key={b.id} className="hover:bg-zinc-50 transition-colors">
                                      ...
                                      <td className="px-4 py-3">
                                        <span
                                          className={`inline-flex items-center rounded-full px-2 py-0.5 text-[9px] font-bold ${statusColor}`}
                                        >
                                          {b.status}
                                        </span>
                                      </td>
                              ...
                              >
                                <div className="flex items-center justify-between px-6 py-4 border-b border-zinc-100 sticky top-0 bg-white z-10">
                                  <div className="flex items-center gap-2">
                                    ...
                                    <h3 className="text-sm font-bold text-zinc-900">
                                      {subLocEditing ? "Edit Booking" : "New Sub-Location Booking"}
                                    </h3>
                                  </div>
                                  <button
                                    type="button"
                                ...
                                <div className="px-6 py-5 grid grid-cols-1 sm:grid-cols-2 gap-3">
                                  <label className="block sm:col-span-2">
                                    ...
                                    <select
                                      value={subLocForm.locationId}
                                      onChange={(e) =>
                                        setSubLocForm((f) => ({ ...f, locationId: e.target.value }))
                                      }
                                      disabled={isSubLocationUser}
                                  ...
                                  <label className="block">
                                    ...
                                    <input
                                      type="text"
                                      value={subLocForm.name}
                                      placeholder="Full name"
                                      onChange={(e) =>
                                        setSubLocForm((f) => ({ ...f, name: e.target.value }))
                                      }
                                  ...
                                  <label className="block">
                                    ...
                                    <input
                                      type="text"
                                      value={subLocForm.phone}
                                      placeholder="+91 9876543210"
                                      onChange={(e) =>
                                        setSubLocForm((f) => ({ ...f, phone: e.target.value }))
                                      }
                                      className="mt-1 w-full rounded-full border border-zinc-200 bg-zinc-50 px-4 py-2 text-xs font-semibold focus:outline-none focus:border-brand transition-all"
                                    />
                                  </label>
                                  ...
                                  <label className="block">
                                    ...
                                    <select
                                      value={subLocForm.doctorId}
                                      onChange={(e) =>
                                        setSubLocForm((f) => ({ ...f, doctorId: e.target.value }))
                                      }
                                  ...
                                  <label className="block">
                                    ...
                                    <input
                                      type="datetime-local"
                                      value={subLocForm.dateTime}
                                      onChange={(e) =>
                                        setSubLocForm((f) => ({ ...f, dateTime: e.target.value }))
                                      }
                                      className="mt-1 w-full rounded-full border border-zinc-200 bg-zinc-50 px-4 py-2 text-xs font-semibold focus:outline-none focus:border-brand transition-all"
                                    />
                                  </label>
                                  <label className="block">
                                    ...
                                    <input
                                      type="text"
                                      value={subLocForm.timeSlot}
                                      placeholder="e.g. 09:00 AM"
                                      onChange={(e) =>
                                        setSubLocForm((f) => ({ ...f, timeSlot: e.target.value }))
                                      }
                                      className="mt-1 w-full rounded-full border border-zinc-200 bg-zinc-50 px-4 py-2 text-xs font-semibold focus:outline-none focus:border-brand transition-all"
                                    />
                                  </label>
                                  <label className="block">
                                    ...
                                    <select
                                      value={subLocForm.status}
                                      onChange={(e) =>
                                        setSubLocForm((f) => ({ ...f, status: e.target.value }))
                                      }
                                      className="mt-1 w-full rounded-full border border-zinc-200 bg-zinc-50 px-4 py-2 text-xs font-semibold focus:outline-none focus:border-brand transition-all cursor-pointer"
                                    >
                                      <option value="Pending">Pending</option>
                                  ...
                                  <label className="block sm:col-span-2">
                                    ...
                                    <input
                                      type="text"
                                      value={subLocForm.reason}
                                      placeholder="Reason for visit"
                                      onChange={(e) =>
                                        setSubLocForm((f) => ({ ...f, reason: e.target.value }))
                                      }
                                      className="mt-1 w-full rounded-full border border-zinc-200 bg-zinc-50 px-4 py-2 text-xs font-semibold focus:outline-none focus:border-brand transition-all"
                                    />
                                  </label>
                                ...
                                <div className="px-6 py-3 border-t border-zinc-100 flex justify-end gap-2 sticky bottom-0 bg-white">
                                  ...
                                  <button
                                    type="button"
                                    disabled={subLocSaving}
                                    onClick={handleSubLocSave}
                            ...
                            >
                              ...
                              >
                                ...
                                <div className="px-6 py-5 space-y-4">
                                  <div className="flex items-center gap-3">
                                    <div className="h-12 w-12 rounded-full bg-zinc-900 text-white flex items-center justify-center font-black text-sm shrink-0">
                                      #{subLocViewing.tokenNo ?? "—"}
                                    </div>
                                  ...
                                  <div className="rounded-xl bg-zinc-50 border border-zinc-100 divide-y divide-zinc-100">
                                    {[
                                      {
                                        label: "Location",
                                        value: `${subLocViewing.locationName || "—"}${subLocViewing.locationCity ? `, ${subLocViewing.locationCity}` : ""}`,
                                      },
                                      { label: "Doctor", value: subLocViewing.doctorName || "—" },
                                      {
                                        label: "Date",
                                        value: new Date(subLocViewing.dateTime).toLocaleString(
                                          "en-US",
                                      ...
                                      {
                                        label: "Type",
                                        value: subLocViewing.appointmentType || "—",
                                      },
                                      ...
                                      >
                                        <span className="text-[10px] font-bold text-zinc-400 w-20 shrink-0 pt-px uppercase">
                                          {label}
                                        </span>
                                ...
                                <div className="px-6 py-3 border-t border-zinc-100 flex justify-end gap-2">
                                  ...
                                  <button
                                    type="button"
                                    onClick={() => openSubLocEdit(subLocViewing)}
                            ...
                            >
                              ...
                              >
                                ...
                                <div className="px-6 py-3 border-t border-zinc-100 flex justify-end gap-2">
                                  <button
                                    type="button"
                                    onClick={() => setSubLocToDelete(null)}
                                    disabled={subLocDeleting}
                  ...
                  >
                    <div className="mb-5">
                      ...
                      <p className="text-sm text-zinc-500">
                        Start remote consultations, admit patients from the waiting room, and
                        document the visit.
                      </p>
                    </div>
                              ...
                              <div className="flex flex-col sm:flex-row items-center gap-4 p-4 rounded-2xl bg-zinc-50 border border-zinc-150">
                                ...
                                <div className="space-y-2 text-left w-full">
                                  <h5 className="text-xs font-bold text-zinc-850">
                                    Clinic Booking QR Code
                                  </h5>
                                  <p className="text-[10px] text-zinc-400 leading-normal">
                                    Display or print this QR code in your clinic. Patients can scan
                                    it using any mobile device to immediately book appointments in
                                    your scheduling portal.
                                  </p>
                                  <div className="flex gap-2">
                                    <a
                    ...
                    {settingsSubTab === "locations" && (
                      <MultiLocationSettings
                        ...
                        professionLabels={{
                          ...
                          sectionDescription:
                            "Create login credentials for each clinic branch. Each location can log in with its own email and password to manage its bookings via the workspace dashboard.",
                  ...
                  (() => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {/* AutoPay subscription management — shown when a mandate exists */}
                        {mySubscription &&
                          (() => {
                            ...
                            {[
                              ...
                              },
                              {
                                ...
                                features: [
                                  ...
                                  "Consultation tracking & Voice Rx",
                                ],
                                popular: true,
                                dark: false,
                ...
                <div className="flex items-center gap-3 text-left">
                  ...
                  <div>
                    <h3 className="text-sm font-bold text-zinc-850 leading-none">
                      {editingApt
                        ? `Edit Clinic Booking ${editingApt.tokenNo ? `(Token #${editingApt.tokenNo})` : ""}`
                        : "Book Appointment"}
                    </h3>
                    <span className="text-[10px] text-zinc-400 mt-1 block">
                      {editingApt
                        ? `Apt ID: ${editingApt.id.substring(0, 8).toUpperCase()}`
                        : "Manual scheduling form for EHR queue"}
                    </span>
                  </div>
                </div>
                <button
                        ...
                        <div className="space-y-1 relative dropdown-container">
                          ...
                          <div className="relative">
                            ...
                            <AnimatePresence>
                              {aptBloodGroupOpen && (
                                <FloatingMenu
                                  open={aptBloodGroupOpen}
                                  anchorRef={aptBloodGroupBtnRef}
                                  estimatedHeight={280}
                                >
                    ...
                    <div className="space-y-4 animate-fade-in">
                      ...
                      <div className="grid gap-4 sm:grid-cols-2">
                        ...
                        <div className="space-y-1">
                          <label className="text-[10px] font-bold text-zinc-400 uppercase pl-1">
                            Email Address{" "}
                            <span className="text-zinc-300 normal-case font-medium">
                              (optional)
                            </span>
                          </label>
                          <div className="relative">
                        ...
                        <div className="space-y-1 relative dropdown-container">
                          ...
                          <div className="relative">
                            ...
                            >
                              <span
                                className={
                                  aptDeptId ? "font-semibold text-zinc-800" : "text-zinc-400"
                                }
                              >
                                {aptDeptId
                              ...
                              <ChevronDown
                                className={`h-4 w-4 text-zinc-400 transition-transform ${aptDeptOpen ? "rotate-180" : ""}`}
                              />
                            </button>
                        ...
                        <div className="space-y-1 relative dropdown-container">
                          ...
                          <div className="relative">
                            ...
                            >
                              <span
                                className={
                                  aptDoctorId ? "font-semibold text-zinc-800" : "text-zinc-400"
                                }
                              >
                                {aptDoctorId
                              ...
                              <ChevronDown
                                className={`h-4 w-4 text-zinc-400 transition-transform ${aptDocOpen ? "rotate-180" : ""}`}
                              />
                            </button>
                            ...
                            <AnimatePresence>
                              {aptDocOpen && (
                                <FloatingMenu
                                  open={aptDocOpen}
                                  anchorRef={aptDocBtnRef}
                                  estimatedHeight={240}
                                >
                                  <div className="w-full bg-white border border-zinc-200 rounded-2xl shadow-xl max-h-56 overflow-y-auto p-1.5 space-y-0.5">
                                    {(aptDeptId
                                      ? doctors.filter((doc) => doc.departmentId === aptDeptId)
                                      : doctors
                                    ).length > 0 ? (
                                      (aptDeptId
                                        ? doctors.filter((doc) => doc.departmentId === aptDeptId)
                        ...
                        <div className="space-y-1 relative dropdown-container">
                          ...
                          <div className="relative">
                            ...
                            <AnimatePresence>
                              {aptCalendarOpen && (
                                <FloatingMenu
                                  open={aptCalendarOpen}
                                  anchorRef={aptCalendarBtnRef}
                                  matchWidth={false}
                                  menuWidth={280}
                                  align="left"
                                  estimatedHeight={360}
                                >
                                  <div className="bg-white border border-zinc-200 rounded-2xl shadow-xl p-4 w-[280px]">
                                    {/* Calendar Navigation */}
                        ...
                        <div className="space-y-1 relative dropdown-container">
                          ...
                          <div className="relative">
                            ...
                            >
                              ...
                              <span
                                className={
                                  aptTimeSlot ? "font-semibold text-zinc-800" : "text-zinc-400"
                                }
                              >
                            ...
                            <AnimatePresence>
                              {aptClockOpen && (
                                <FloatingMenu
                                  open={aptClockOpen}
                                  anchorRef={aptClockBtnRef}
                                  matchWidth={false}
                                  menuWidth={280}
                                  align="right"
                                  estimatedHeight={320}
                                >
                                  <div className="bg-white border border-zinc-200 rounded-2xl shadow-xl p-3 w-[280px]">
                        ...
                        <div className="grid gap-3 sm:grid-cols-2 text-[11px] text-left">
                          ...
                          <div className="space-y-1 sm:col-span-2 border-t border-zinc-200/60 pt-2">
                            ...
                            <p className="font-semibold text-zinc-700">
                              Dr.{" "}
                              {doctors.find((d) => d.id === aptDoctorId)?.name || "Select Doctor"} (
                              {departments.find((d) => d.id === aptDeptId)?.name ||
                                "Select Department"}
                              )
                            </p>
