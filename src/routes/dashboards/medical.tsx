...
function MedicalDashboardPage() {
  ...
  useEffect(() => {
    ...
    try {
      const validTabs = ["overview", "scribe", "calendar", "patients", "analytics", "settings", "appointments", "plans", "whatsapp", "subLocationBookings"];
                        ...
                        <div className="space-y-3 text-center">
                          ...
                          <div>
                            ...
                            <p className="text-[10px] text-zinc-400 mt-1">
                              BookMyTime is synthesizing the dialogue into standard SOAP format...
                            </p>
                          </div>
                        </div>
                      )}
                  ...
                  <div className="grid gap-6 md:grid-cols-3">
                    {[
                      ...
                      >
                        ...
                        <button
                          ...
                          className={`mt-6 w-full rounded-lg py-2.5 text-xs font-bold transition-all cursor-pointer disabled:cursor-not-allowed ${
                            plan.active && hasPaid
                              ...
                              : plan.active && plan.name !== "Enterprise" && plan.name !== "Hospital"
                        ...
                        {plan.active && trialActive && plan.name !== "Enterprise" && plan.name !== "Hospital" && (
