...
function DashboardPage() {
  ...
  const [actionPlanDeliverables, setActionPlanDeliverables] = useState<
  ...
  const handleSubscribeAutoPay = useCallback(
    async (planTier: "Basic" | "Premium") => {
      ...
      try {
        ...
        // In redirect mode a successful call navigates away; if it returns here
        // with an error, surface it instead of silently doing nothing.
  ...
  return (
    <div className="flex h-screen w-full overflow-hidden bg-zinc-50 font-sans text-zinc-900 relative">
              ...
              >
                ...
                <div className="text-left hidden sm:block">
                  ...
                  <p className="text-[10px] text-zinc-400 leading-tight truncate max-w-[80px]">
                    {user?.role === "admin" ? "Hosp. Admin" : user?.role || "Consultant"}
                  </p>
                </div>
                        ...
                        <div className="space-y-4">
                          ...
                          {showAddAdvisoryModal && (
                            <div className="rounded-2xl border border-brand/20 bg-brand/5 p-4 space-y-3 text-xs">
                              <h5 className="text-[10px] font-black text-brand uppercase tracking-wider">
                                New Consultation/Advisory Note
                              </h5>
                              <div className="grid grid-cols-1 gap-3">
                                ...
                                <div className="space-y-1">
                                  <label className="text-[9px] font-bold uppercase text-zinc-400 tracking-wider block">
                                    Consultant Findings &amp; Observations
                                  </label>
                                  <textarea
                                    rows={2}
                          ...
                          {patientChartData === null ? (
                            ...
                            <div className="py-12 text-center text-zinc-400 italic text-xs">
                              No consultation or advisory notes logged yet. Click "Add Advisory
                              Note" to get started.
                            </div>
                          ) : (
                            <div className="space-y-4">
                      ...
                      {patientProfileTab === "prescriptions" && (
                        <div className="space-y-4">
                                    ...
                                    <div className="col-span-1 flex items-center justify-center">
                                      {actionPlanDeliverables.length > 1 && (
                                        <button
                                          type="button"
                                          onClick={() =>
                                            setActionPlanDeliverables(
                                              actionPlanDeliverables.filter((_, i) => i !== dIdx),
                                            )
                                          }
                          ...
                          {patientChartData === null ? (
                            ...
                            <div className="py-12 text-center text-zinc-400 italic text-xs">
                              No action plans mapped to this client profile. Click "Add Action Plan"
                              to create one.
                            </div>
                          ) : (
                            <div className="space-y-6">
                  ...
                  >
                    ...
                    <div className="border-b border-zinc-100 pb-4">
                      ...
                      <p className="text-[10px] text-zinc-400 mt-1.5 leading-relaxed">
                        Configure firm profiles, working hours, departments, doctor directory
                              ...
                              <div className="flex flex-col sm:flex-row items-center gap-4 p-4 rounded-2xl bg-zinc-50 border border-zinc-150">
                                ...
                                <div className="space-y-2 text-left w-full">
                                  <h5 className="text-xs font-bold text-zinc-850">
                                    Firm Booking QR Code
                                  </h5>
                                  <p className="text-[10px] text-zinc-400 leading-normal">
                                    Display or print this QR code in your office/firm. All clients
                                    can scan it using any mobile device to immediately book
                                    appointments in your scheduling portal.
                                  </p>
                    ...
                    {settingsSubTab === "locations" && (
                      <MultiLocationSettings
                        ...
                        professionLabels={{
                          ...
                          sectionDescription:
                            "Create login credentials for each firm/office branch. Each location can log in with its own email and password to manage its bookings via the workspace dashboard.",
                ...
                <div className="flex-1 p-5 sm:p-6 space-y-4 text-left overflow-y-auto min-h-0">
                  ...
                  {bookingStep === 3 && (
                    <div className="space-y-4 animate-fade-in">
                      ...
                      <div className="space-y-1">
                        <label className="text-[10px] font-bold text-zinc-400 uppercase pl-1">
                          Reason for Visit / Business Goals
                        </label>
                        <div className="relative">
      ...
      {/* Subscription success / pending confirmation modal */}
      <AnimatePresence>
        {subscriptionSuccess && (
