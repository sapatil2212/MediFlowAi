...
export const Route = createFileRoute("/dashboards/professional")({
  head: () => ({
    meta: [
      { title: "Firm Dashboard — MediFlow AI" },
      {
        name: "description",
                    ...
                    {[
                      {
                        ...
                        features: ["1 advisor dashboard", "500 appointments / mo", "Up to 500 client records", "AI action plans standard"],
                        action: "Selected",
                      ...
                      },
                      {
                        ...
                        features: ["Up to 5 advisors", "2,000 appointments / mo", "Up to 5,000 client records", "WhatsApp alerts included", "Receptionist dashboard"],
                        action: "Upgrade",
