...
replacements = [
    ...
    # SOAP labels in training notes
    ('Subjective', 'Client Feedback'),
    ('Objective', 'Trainer Observations'),
    ('Assessment', 'Focus & Performance'),
    ('Plan', 'Next Workout Target'),
    ...
    ('MD, FACP - Family Medicine Specialist', 'Certified Personal Trainer, Strength Coach'),
